...
def Stock_SMA(stock,country):
    ...
    plt.savefig('C:/Users/Admin/Desktop/test_analitic/test/SMA.png')
    plt.show()
...
def Stock_EMA(stock,country):
    ...
    plt.ylabel('Close price')
    plt.legend(loc = 'upper left')
    plt.savefig('C:/Users/Admin/Desktop/test_analitic/test/EMA.png')
    plt.show()
...
def Upper_levels(stock,country):
    ...
    plt.legend(loc = 'upper left')
    plt.savefig('C:/Users/Admin/Desktop/test_analitic/test/Upper.png') 
    plt.show()
...
def Low_levels(stock,country):
    ...
    for index in range(len(pivots)):
        plt.plot_date([dates[index],dates[index]+timeD],[pivots[index],pivots[index]], linestyle ='-',linewidth = 2,marker = ",")
    plt.legend(loc = 'upper left')
    plt.savefig('C:/Users/Admin/Desktop/test_analitic/test/Low.png') 
    plt.show()
    print('Dates / Prices of pivot points:')
    for index in range(len(pivots)):
        print(str(dates[index].date())+': '+str(pivots[index]))
...
def Last_Month(stock,country):
    ...
    plt.ylabel('Close price')
    plt.legend(loc = 'upper left')
    plt.savefig('C:/Users/Admin/Desktop/test_analitic/test/Mounth.png')
    plt.show()
